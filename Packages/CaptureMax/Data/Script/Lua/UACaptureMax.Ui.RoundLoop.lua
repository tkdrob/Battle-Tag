...
--[[--------------------------------------------------------------------------
--
-- File:            UACaptureMax.Ui.RoundLoop.lua
...
require "UACaptureMax.UILeaderboardItem"

--[[ Class -----------------------------------------------------------------]]

UACaptureMax.Ui = UACaptureMax.Ui or {}
UACaptureMax.Ui.RoundLoop = UTClass(UIMenuPage)

-- default

	--[[UACaptureMax.Ui.RoundLoop.profiles = UACaptureMax.Ui.RoundLoop.profiles or {
...
function UACaptureMax.Ui.RoundLoop:__ctor(...)
    ...
    self.uiLeaderboard.uiItem = UACaptureMax.UILeaderboardItem
    self.uiLeaderboard:Build(activity.match.challengers, "heap")
end

-- __dtor -------------------------------------------------------------------

function UACaptureMax.Ui.RoundLoop:__dtor()    

end

-- Update -------------------------------------------------------------------

function UACaptureMax.Ui.RoundLoop:Update()
end

-- OnClose -------------------------------------------------------------------

function UACaptureMax.Ui.RoundLoop:OnClose()
