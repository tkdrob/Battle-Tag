...
function UACapture:__ctor(...)
    ...
    self.settings = {
        ...
        [1] = { title = l"titlemen006", options = {
            ...
            [1] = { displayMode = nil, label = l"goption001", tip = l"tip112", choices = { { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 }, { value = 25 }, { value = 30 } }, index = "playtime", },
			...
			[3] = { label = l"goption021", tip = l"tip132", choices = { { value = 5 }, { value = 10 }, { value = 15 }, { value = 20 }, { value = 25 } }, index = "capturepointsplayer" },
            [4] = { displayMode = nil, label = l"goption007", tip = l"tip040", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 1, displayMode = "medium", text = l"oth082" }, { value = 2, displayMode = "medium", text = l"oth111" } }, index = "swap", },
			[5] = { label = l"goption026", tip = l"tip137", choices = { { value = 1 }, { value = 2 }, { value = 3 }, { value = 4 }, { value = 5 } }, index = "capturepointsteam" },
            [6] = { label = l"goption022", tip = l"tip133", choices = { { value = 0, displayMode = "medium", text = l"oth076" }, { value = 10 }, { value = 20 }, { value = 30 }, { value = 40 }, { value = 50 }, { value = 60 } }, index = "timeleft" },
            [7] = { displayMode = nil, label = l"goption036", tip = l"tip153", choices = { { value = 0, displayMode = "medium", text = l"oth086" }, { value = 1, displayMode = "medium", text = l"oth087" } }, index = "endgamemode", },
            [8] = { label = l"goption042", tip = l"tip181", choices = { { value = 1 }, { value = 3 }, { value = 5 }, { value = 10 }, { value = 15 }, { value = -1, text = "", icon = "base:texture/ui/components/uiradiobutton_infinity.tga" } }, index = "capturegoal" },
            [9] = { displayMode = nil, label = l"goption043", tip = l"tip182", choices = { { value = 0, displayMode = "large", text = l"oth099" }, { value = 1, displayMode = "medium", text = l"oth100" } }, index = "wincondition", },
...
function UACapture:InitEntityHeapData(entity, ranking)
	...
	if (entity:IsKindOf(UTTeam)) then
		...
		if (entity.primary) then
			...
			entity.gameplayData = { 0x00, 0x00, 0x00, entity.team.index + 1 }
